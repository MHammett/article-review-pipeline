...
class TestLanguageTool:
    ...
    def test_run_languagetool_failure(self):
        ...
        with patch("ci_article_review.adapters.grammar.languagetool.check_text", side_effect=Exception("API down")):
    ...
    def test_run_languagetool_success(self):
        ...
        with patch("ci_article_review.adapters.grammar.languagetool.check_text", return_value=mock_response):
...
class TestOpenAI:
    ...
    def test_successful_call(self):
        ...
        with patch("ci_article_review.adapters.review.openai.requests.Session") as mock_session_cls:
...
class TestMistral:
    ...
    def test_reasoning_chunked_content_accumulated(self):
        ...
        with patch("ci_article_review.adapters.review.mistral.requests.Session") as mock_session_cls:
            mock_session = MagicMock()
            mock_session_cls.return_value = mock_session
            mock_session.post.return_value = _sse_mock(lines)
...
class TestGemini:
    ...
    def test_successful_call(self):
        ...
        with patch("ci_article_review.adapters.review.gemini.requests.Session") as mock_session_cls:
            mock_session = MagicMock()
            mock_session_cls.return_value = mock_session
            mock_session.post.return_value = self._mock_response(content)
...
class TestGrok:
    ...
    def test_successful_call(self):
        ...
        with patch("ci_article_review.adapters.review.grok.requests.Session") as mock_session_cls:
            mock_session = MagicMock()
            mock_session_cls.return_value = mock_session
            mock_session.post.return_value = self._mock_response(content)
...
class TestClaude:
    ...
    def test_successful_call(self):
        ...
        with patch("ci_article_review.adapters.review.claude.requests.Session") as mock_session_cls:
            mock_session = MagicMock()
            mock_session_cls.return_value = mock_session
            mock_session.post.return_value = self._mock_response(content)
...
class TestProviderDispatch:
    ...
    def test_gemini_default_uses_aistudio(self):
        from ci_article_review.adapters.review import gemini
        with patch("ci_article_review.adapters.review.gemini._call_aistudio") as mock_ai, \
    ...
    def test_gemini_vertex_ai_dispatches_to_vertex(self):
        ...
        with patch("ci_article_review.adapters.review.gemini._call_vertex") as mock_vx, \
    ...
    def test_gemini_model_from_provider_config(self):
        ...
        with patch("ci_article_review.adapters.review.gemini._call_aistudio", side_effect=fake_aistudio):
            gemini.call("sys", "usr", "key", retry=False, provider_config=cfg)
    ...
    def test_openai_default_uses_openai_backend(self):
        from ci_article_review.adapters.review import openai as oai
        with patch("ci_article_review.adapters.review.openai._call_openai") as mock_oa, \
    ...
    def test_openai_azure_dispatches_to_azure(self):
        ...
        with patch("ci_article_review.adapters.review.openai._call_azure") as mock_az, \
    ...
    def test_mistral_default_uses_laplateforme(self):
        from ci_article_review.adapters.review import mistral
        with patch("ci_article_review.adapters.review.mistral._call_laplateforme") as mock_lp, \
    ...
    def test_mistral_azure_dispatches_to_azure(self):
        ...
        with patch("ci_article_review.adapters.review.mistral._call_azure") as mock_az, \
             patch("ci_article_review.adapters.review.mistral._call_laplateforme") as mock_lp:
            mock_az.return_value = {"failed": False, "data": {}, "model": "x", "tokens": {}, "elapsed_seconds": 0}
...
class TestCheckProviderDispatch:
    ...
    def test_check_openai_calls_correct_url(self):
        ...
        with patch("ci_article_review.check.requests.post", return_value=resp) as mock_post:
