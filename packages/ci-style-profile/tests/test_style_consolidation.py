"""Tests for style_consolidation.py."""
...
class TestConsolidateLists:
    def test_claude_openai_pass_threshold(self):
        ...
        from ci_style_profile.style_consolidation import consolidate_lists
...
class TestCollectProse:
    def test_sorted_by_weight_descending(self):
        ...
        from ci_style_profile.style_consolidation import collect_prose

        results = {
            "mistral": {
                "failed": False,
                "_parsed": {"style_profile": "mistral prose"},
                "tokens": {},
            },
            "claude": {
                "failed": False,
                "_parsed": {"style_profile": "claude prose"},
                "tokens": {},
            },
            "openai": {
                "failed": False,
                "_parsed": {"style_profile": "openai prose"},
                "tokens": {},
            },
        }
        entries = collect_prose(results, "style_profile")
    ...
    def test_failed_excluded(self):
        ...
        results = {
            ...
            "openai": {
                "failed": False,
                "_parsed": {"style_profile": "openai result"},
                "tokens": {},
            },
        }
        entries = collect_prose(results, "style_profile")
...
class TestConsolidateDetection:
    def test_consolidate_calls_claude(self):
        ...
        from ci_style_profile.style_consolidation import consolidate_detection

        detection_results = {
            "claude": {
                "content": '{"detected_styles": [{"label": "technical", "description": "Long form", "features": {}, "source_distribution": {}, "sample_ids": [], "confidence": "high"}], "overall_confidence": "high", "consolidation_notes": ""}',
                "failed": False,
            },
            "openai": {
                "content": '{"detected_styles": [{"label": "technical analysis", "description": "Analytical", "features": {}, "source_distribution": {}, "sample_ids": [], "confidence": "high"}], "overall_confidence": "high", "consolidation_notes": ""}',
                "failed": False,
            },
        }

        mock_response = {
            "content": '{"detected_styles": [{"label": "technical", "description": "Unified", "features": {}, "source_distribution": {}, "sample_ids": [], "confidence": "high"}], "overall_confidence": "high", "consolidation_notes": "agreed"}',
            "failed": False,
        ...
        with patch(
            "ci_style_profile.style_consolidation.call_one", return_value=mock_response
        ):
            result = consolidate_detection(detection_results, user_config)

        assert result is not None
        raw_styles, overall_confidence = result
        assert len(raw_styles) >= 1
        assert raw_styles[0]["label"] == "technical"
