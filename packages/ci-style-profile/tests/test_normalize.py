...
class TestCleanText:
    def test_strips_wp_shortcodes(self):
        from ci_style_profile.normalize import clean_text
...
class TestSentenceSplit:
    def test_abbreviations_dont_split(self):
        from ci_style_profile.normalize import sentence_split
...
class TestComputeMetrics:
    def test_metrics_on_known_text(self):
        from ci_style_profile.normalize import compute_metrics
...
class TestDeduplicate:
    def test_drops_exact_duplicates(self):
        from ci_style_profile.normalize import deduplicate
...
class TestCorpusSummary:
    def test_aggregates_correctly(self):
        from ci_style_profile.normalize import corpus_summary
...
class TestCorpusBiasWarnings:
    def test_fires_above_75_percent(self):
        from ci_style_profile.normalize import corpus_bias_warnings, corpus_summary
