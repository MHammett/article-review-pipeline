...
_ADAPTER_MODULES: dict[str, str] = {
    "gemini":     "adapters.review.gemini",
    "openai":     "adapters.review.openai",
    "mistral":    "adapters.review.mistral",
    "grok":       "adapters.review.grok",
    "claude":     "adapters.review.claude",
    "perplexity": "adapters.review.perplexity",
}
